                    ...
                    <CardBody>
                        ...
                        <Chart
                            ...
                            data={[
                                ...
                                ['2015', 3.43, 'color: #ABBEE6', null],
                                ['2016', 3.53, 'color: #CBAACB', null],
                                ['2017', 2.94, 'color: #FFFFB5', null],
                                ['2018', 2.94, 'color: #FFCCB6', null],
                                ['2019', 3.64, 'color: #F3B0C3', null],
                                ['2020', 3.64, 'color: #8ED1FC', null],
                            ]}
                            options={{
                                width: '100%',
                                height: 400,
